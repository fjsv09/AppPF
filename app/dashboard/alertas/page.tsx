            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-6">
                <div>
                    <div className="flex items-center gap-3">
                        <BackButton />
                        <h1 className="text-xl md:text-3xl font-bold text-white tracking-tight">Centro de Alertas</h1>
                    </div>
                    <p className="text-slate-400 mt-2 md:mt-1">Monitoreo de seguridad y acciones críticas</p>
                </div>
            </div>
