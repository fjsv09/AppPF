...
interface Solicitud {
    ...
    created_at: string
    cliente: { id: string; nombres: string; dni: string; telefono?: string; foto_perfil?: string }
                                ...
                                >
                                    <div className="flex flex-col py-3 px-4 gap-3 relative bg-gradient-to-br from-slate-900/50 to-slate-900/10 hover:bg-slate-800/20 transition-colors">
                                        ...
                                        <div className="flex items-center gap-2 mt-2 pt-2 border-t border-slate-800/40">
                                            {sol.estado_solicitud === 'aprobado' && userRole === 'admin' && (
                                                <Button
                                                    size="sm"
                                                    variant="outline"
                                            ...
                                            {sol.estado_solicitud === 'aprobado' && (userRole === 'admin' || userRole === 'supervisor') && (
                                                <DocumentButtonAsync
                                                    solicitudId={sol.id}
                                                    type="renovacion"
