        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="border-b border-white/5 pb-6">
                <div className="flex items-center gap-3">
                    <BackButton />
                    <div>
                        <h1 className="text-xl md:text-2xl font-bold text-white tracking-tight">Panel de Supervisión</h1>
                        <p className="text-slate-500 text-xs mt-0.5">Rendimiento de tu equipo de asesores</p>
                    </div>
                </div>
            </div>
