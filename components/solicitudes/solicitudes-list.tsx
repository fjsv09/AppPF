...
import { FileText, Clock, CheckCircle, XCircle, AlertCircle, Eye, Users, Calendar, DollarSign, Search, X, Filter, ArrowUp, ArrowDown, MapPin, Activity, Loader2, Wallet, ChevronDown } from 'lucide-react'
                                                ...
                                                <div className="flex items-start justify-between gap-3">
                                                    <div className="flex items-center gap-2.5 min-w-0">
                                                        {solicitud.cliente?.foto_perfil ? (
                                                            <ImageLightbox
                                                                src={solicitud.cliente.foto_perfil}
                                                                alt={solicitud.cliente.nombres || 'Cliente'}
                                                                thumbnail={
                                                                    <div className="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 shrink-0 overflow-hidden cursor-zoom-in">
                                                    ...
                                                    <div className="shrink-0 text-right flex flex-col items-end gap-1">
                                                         ...
                                                         <span className="text-[9px] text-slate-500 font-mono" title="Última edición" suppressHydrationWarning>
                                                             {formatDateTime(solicitud.updated_at || solicitud.created_at)}
                                                        </span>
                                                    </div>
                                                </div>
                                        ...
                                        >
                                            ...
                                            <div className="col-span-3 flex items-center gap-3 min-w-0">
                                                {solicitud.cliente?.foto_perfil ? (
                                                    <ImageLightbox
                                                        ...
                                                        alt={solicitud.cliente.nombres || 'Cliente'}
                                                        thumbnail={
                                                            <div className="w-9 h-9 rounded-full bg-slate-800 border border-slate-700 shrink-0 overflow-hidden cursor-zoom-in">
                                                                <img src={solicitud.cliente.foto_perfil} alt="" className="w-full h-full object-cover" />
                                                            </div>
                                                        }
                                                    />
                                            ...
                                            <div className="col-span-2 flex flex-col items-center justify-center text-center">
                                                <span className="text-xs font-medium text-slate-300">
                                                    {formatDate(solicitud.updated_at || solicitud.created_at)}
                                                </span>
                                                <span className="text-[10px] text-slate-500 font-mono" suppressHydrationWarning>
                                                    {formatTime(solicitud.updated_at || solicitud.created_at)}
                                                </span>
                                            </div>
