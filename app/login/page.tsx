...
import { CardContent, CardTitle, CardDescription, CardFooter } from '@/components/ui/card'
                ...
                <div className="backdrop-blur-xl bg-slate-900/60 border border-white/10 rounded-3xl shadow-2xl shadow-black/50 overflow-hidden">
                    ...
                    <div className="p-8">
                        <div className="mb-8 text-center">
                            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 mb-6 shadow-lg">
                                <span className="text-3xl">🛡️</span>
                            </div>
                            <CardTitle className="text-3xl font-bold text-white mb-2 tracking-tight">Sistema PF</CardTitle>
