...
import { Zap, Briefcase, RefreshCw, AlertCircle } from 'lucide-react'
...
export function QuickActions({ rol }: QuickActionsProps) {
    const [data, setData] = useState<{solicitudes: any[], renovaciones: any[]}>({ solicitudes: [], renovaciones: [] })
                            ...
                            <div key={ren.id} className="px-4 py-2.5 hover:bg-white/5 transition-colors group flex items-center gap-3">
                                <div className="min-w-0 flex-1">
                                    ...
                                    <div className="flex items-center gap-2 mt-0.5">
                                        ...
                                        <span className="text-[7px] px-1 bg-purple-500/10 text-purple-400 rounded border border-purple-500/10 uppercase font-black text-center">
                                            RENOV.
                                        </span>
                                    </div>
                                </div>
