...
const connectionString = process.env.DATABASE_URL || `postgresql://postgres.kaxwuclrddyeetflneil:${process.env.PASSSUPABASE}@aws-0-us-west-1.pooler.supabase.com:6543/postgres`;
...
async function main() {
    try {
        ...
        console.log("Sectores actuales:", res);
