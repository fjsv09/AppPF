import { Users, ShieldCheck, Wallet, Contact, Banknote, Award } from 'lucide-react'
...
export function OperationsHub() {
    return (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            ...
            <Link href="/dashboard/cuadre" className="group p-4 md:p-5 bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-xl md:rounded-2xl hover:border-emerald-500/50 transition-all shadow-xl relative overflow-hidden">
